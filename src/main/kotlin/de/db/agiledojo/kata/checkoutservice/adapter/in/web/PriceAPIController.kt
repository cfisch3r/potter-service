package de.db.agiledojo.kata.checkoutservice.adapter.`in`.web

import de.db.agiledojo.kata.checkoutservice.application.domain.model.Amount
import de.db.agiledojo.kata.checkoutservice.application.domain.model.PotterVolume
